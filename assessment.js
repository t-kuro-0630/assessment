(function () {
    ...
    assessmentButton.onclick = function(){
        ...
        const hrefValue = 'https://twitter.com/intent/tweet?button_hashtag=あなたのいいところ&ref_src=twsrc%5Etfw&text=' + encodeURI(result);
    ...
    const answers = [
        '{userName}のいいところは声です。{userName}の特徴的な声は皆を惹き付け、心にのこります。',
